<?php 
    ...
    $user_id = $_GET['id'];
    $command_2 = "SELECT * FROM `students` WHERE id='$user_id'";
...
<body>
    ...
    <div class="student_form_update">
            ...
            <form method="post" class="signin_form">
                ...
                <div class="container_info_login">
                    <label>First Name : </label>
                    <input type="text" name="f_name" value="<?php echo $row_2['f_name'] ?>"required>
                    <br><br>
                    <label>Last name : </label>
                    <input type="text" name="l_name" value="<?php echo $row_2['l_name'] ?>"required>
                    <br><br>
                    <label>Email : </label>
                    <input type="email" name="email" value="<?php echo $row_2['email'] ?>"required>
                    <br><br>
                    <label>Password : </label>
                    <input type="text" name="password"  value="<?php echo $row_2['password'] ?>" required>
                    <br><br>
                    <label>Grade : </label>
                    <select name="grade">
                        <option value="Grade 1">Grade 1</option>
